package com.xjc.seatatcc.order.feign;
...
public interface StorageApi {
    ...
    boolean decrease(@RequestBody BusinessActionContext actionContext, @RequestParam("productId") String productId, @RequestParam("count") Integer count);
